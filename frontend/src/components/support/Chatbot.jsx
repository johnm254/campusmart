...
const Chatbot = () => {
    ...
    const knowledgeBase = {
        ...
        questions: [
            ...
            // Listings & Selling
            { cat: 'selling', q: 'How do I post an item for sale?', a: 'Click the "Sell" button in the navigation bar. Fill in the details, upload up to 5 photos, and click "Post Product". ItΓÇÖs 100% free!' },
            ...
            { cat: 'selling', q: 'Why isnΓÇÖt my listing showing?', a: 'New listings may undergo a quick review. If it' + "'" + 's been over 2 hours, please ensure your listing doesn' + "'" + 't violate our community policies.' },
